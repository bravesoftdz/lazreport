...
//--- VarForm resources -------------------------------------------------------
  ...
  sVarFormCapVar = 'Variable';
  sVarFormCapCat = 'Categoria';
  sVarFormCapEdit = 'Editar';
  sVarFormCapDel = 'Eliminar';
  sVarFormCapNew = 'Nueva';
  sVarNodeNotEdit = 'not edit';
...
//--- PreviewForm resources ---------------------------------------------------
  ...
  sPreviewFormFirsPage='Ir a la primera página';
  sPreviewFormLastPage='Ir a la última página';
  sPreviewFormNextPage='Siguiente página';
  sPreviewFormPrevPage='Página anterior';

  sPreviewFormZoomP='Acercar';
  sPreviewFormZoomM='Alejar';
...
const
  ...
  FR_U_CM       = 38; {*px - Equivalente a un centrimetro en pixeles*}
  FR_U_INCH     = 96; (*px - Equivalente a 2.54 cm  *)
  FR_U_MM       = 3.8;{*px - Equivalente a un Milimetro en pixeles}
  FR_U_PPI      = 96; {*Resolución de impresión equivalente a 96 pixceles por pulgada}
